<template>
<div class="container">
  <h2>Welcome to H&G Ideas</h2>
  <p>These terms and conditions outline the rules and regulations for the use of H&G Ideas's Website.</p>
  <br />
  <span style="text-transform: capitalize;">H&G Ideas</span> is located at:
  <br />
  <address>
    2592 Levy Court Framingham, Framingham
    <br />01701 - Massachusetts , United State
    <br />
  </address>
  <p>
    By accessing this website we assume you accept these terms and conditions in full. Do not continue to use H&G Ideas's website
  ...
  <p>
    ...
    of United State. Any use of the above terminology or other words in the singular, plural,
    capitalisation and/or he/she or they, are taken as interchangeable and therefore as referring to same.
  </p>
  <h2>Cookies</h2>
  <p>
    We employ the use of cookies. By using H&G Ideas's website you consent to the use of cookies
    in accordance with H&G Ideas's privacy policy.
  </p>
  <p>
  ...
  <h2>License</h2>
  <p>
    Unless otherwise stated, H&G Ideas and/or it's licensors own the intellectual property rights for
    all material on H&G Ideas. All intellectual property rights are reserved. You may view and/or print
    pages from https://housegardenideas.com/ for your own personal use subject to restrictions set in these terms and conditions.
  </p>
  <p>You must not:</p>
  <ol>
    <li>Republish material from https://housegardenideas.com/</li>
    <li>Sell, rent or sub-license material from https://housegardenideas.com/</li>
    <li>Reproduce, duplicate or copy material from https://housegardenideas.com/</li>
  </ol>
  <p>Redistribute content from H&G Ideas (unless content is specifically made for redistribution).</p>
  <h2>User Comments</h2>
  <ol>
    <li>This Agreement shall begin on the date hereof.</li>
    <li>
      Certain parts of this website offer the opportunity for users to post and exchange opinions, information,
      material and data ('Comments') in areas of the website. H&G Ideas does not screen, edit, publish
      or review Comments prior to their appearance on the website and Comments do not reflect the views or
      opinions ofH&G Ideas, its agents or affiliates. Comments reflect the view and opinion of the
      person who posts such view or opinion. To the extent permitted by applicable laws H&G Ideasshall
    ...
    <li>
      H&G Ideasreserves the right to monitor all Comments and to remove any Comments which it considers
    ...
    <li>
      You hereby grant to
      <strong>H&G Ideas</strong> a non-exclusive royalty-free license to use, reproduce,
  ...
  <ol start="2">
    ...
    <li>
      ...
      <ol>
        ...
        <li><b>HouseGardenIdeas.com</b> community sites;</li>
  ...
  <p>
    ...
    the visibility associated with the hyperlink outweighs the absence of H&G Ideas and (d) where the
  ...
  <p>
    ...
    <a
      href="mailto:housegardenideas@gmail.com"
      title="send an email to housegardenideas@gmail.com"
    >housegardenideas@gmail.com</a>.
  ...
  <p>
    No use of H&G Ideas's logo or other artwork will be allowed for linking absent a trademark license
    agreement.
  </p>
  <h2>Iframes</h2>
  <p>
...
export default {
  ...
  head() {
    ...
    let structuredData = {
      ...
      "@type": "WebPage",
      name: "Terms of Use | House Garden Ideas",
      url:domain+"/about/terms-of-use",
      description: "These terms and conditions outline the rules and regulations for the use of H&G Ideas's Website."
    };
    return {
      title: "Terms of Use | House Garden Ideas",
      description:
        "These terms and conditions outline the rules and regulations for the use of H&G Ideas's Website.",
